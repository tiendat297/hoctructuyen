                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-header p-4 bg-primary">
                                <h4 class="text-white text-center mb-0 mt-0">Ba Đờn guitar</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{  url("home_admin") }}" class="p-2" method="post">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="emailaddress">User name:</label>
                                        <input class="form-control" type="email" id="emailaddress" name="username" required="" placeholder="john@deo.com">
                                    </div>
