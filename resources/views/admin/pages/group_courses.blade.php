                                            ...
                                            <table id="tech-companies-1 st_table " class="table table-striped mb-0 data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <button  data-id="{{ $group -> id }}" data-toggle="modal" class="badge badge-danger xoa_nhom" data-target="#delete" id="sa-warning" ><i class="fas fa-archive"></i> Xóa</button>
                                                             <a    href="{{ url('suanhom',['id' => $group -> id]) }}"  class="badge badge-success"  > <i class="ion ion-md-create"></i> Sửa</a></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="col-lg-15">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-4">Thông tin nhóm khóa học</h4>

                                <form class="parsley-examples" action="{{ "them_group" }}" method="POST" >
                                    @csrf
                                    <div class="form-group">
                                        <label for="userName">Tên nhóm khóa học<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="userName">Search<span class="text-danger">*</span></label>
                                        <input type="text" name="search" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                    </div>
