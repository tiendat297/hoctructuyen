            ...
            <div class="content-page">
                ...
                <div class="row">
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-4 header-title">Thông tin nhóm khóa học</h4>
                ...
                @foreach ($data as $group)
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Tên nhóm khóa học</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="hoten" value="{{ $group -> name }}"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control ckeditor" rows="10" id="example-textarea" type="text" name="description" {{ $group -> description }}>{{ $group -> description }}</textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                           <img style="width:140px; height:170px;" src="assets\admin\images\{{ $group -> images }}" alt=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="example-date" readonly="" type="text" name="date" value="{{ $group -> created_at }}">
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-4">DANH SÁCH KHÓA HỌC THUỘC NHÓM</h4>
