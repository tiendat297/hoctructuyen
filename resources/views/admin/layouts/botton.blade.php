...
<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown d-none d-lg-block">
            <a class="nav-link dropdown-toggle mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="assets\admin\images\flags\us.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="assets\admin\images\flags\germany.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">German</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="assets\admin\images\flags\italy.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Italian</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="assets\admin\images\flags\spain.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Spanish</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="assets\admin\images\flags\russia.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Russian</span>
                </a>
            </div>
        </li>
                    ...
                    <div class="inbox-widget">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="assets\admin\images\users\avatar-1.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="assets\admin\images\users\avatar-2.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="assets\admin\images\users\avatar-3.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="assets\admin\images\users\avatar-4.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="assets\admin\images\users\avatar-5.jpg" class="rounded-circle" alt=""></div>
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                <!-- item-->
                <a href="{{ 'logout_admin' }}" class="dropdown-item notify-item">
    ...
    <div class="logo-box">
        ...
        <a href="{{ "home_admin" }}" class="logo text-center logo-light">
            <span class="logo-lg">
                <img href="{{ "courses_admin" }}" src="assets\admin\images\Đen_và_Nâu_Hình_vuông_Cộng_đồng_và_Tổ_chức_phi_lợi_nhuận_Biểu_trưng-removebg-preview.PNG" alt="" height="60">
